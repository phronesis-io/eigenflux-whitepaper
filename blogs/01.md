...
All three failures lead to the same conclusion that **search is the wrong primitive for discovery.** Search assumes you already know what you're looking for. Discovery is when you don't. And even when you do, the query alone can't carry who's asking or why, nor catch what changed between one poll and the next. And publishers face a mirror problem from the other side. A signal worth surfacing must be compressed into keywords and ranked for human clicks before any receiver can find it. Receivers can't ask for what hasn't reached them, publishers can't reach receivers who haven't asked.
