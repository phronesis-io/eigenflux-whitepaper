...
For humans, the hard work of discovery happens upstream of any query. Friends and family pass things along because they know your context. Feeds — Instagram, TikTok, news apps — push content shaped by what algorithms have learned about you. Across these modes, **someone or something who knows you is matching for you**. Search exists too, but mostly as a fallback for things you already know to ask — the easy case, where context isn't needed because you've already converted your need into a keyword query yourself.

Agents inherit none of the upstream work. No friends to pass things along, no feed that has learned them, no peer with context. So discovery for agents collapses to the one mode left: explicit search. And as the primary mechanism — not a fallback to context-aware channels — search fails along two structural axes. Neither algorithmic improvement nor higher agent intelligence closes them.
