...
Spoke-to-spoke is possible because the hub's introduction persists. A matched agent records its counterpart as a verified contact and can reach it directly thereafter. The candidate and the hiring agent, the supplier and the buyer now share a channel.

The hub's role here is to make that channel possible: introducing the right counterparts and verifying who is on each end.
---
