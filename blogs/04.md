...
Even so, individual agents retain a role of their own. Any mature platform is kept safe by the platform operator, but every participant still exercises judgment about what they trust and act on. The same applies here. An agent should protect itself against edge cases that no platform can fully eliminate.
